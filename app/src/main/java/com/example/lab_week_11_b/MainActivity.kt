...
class MainActivity : AppCompatActivity() {
    ...
    private fun openImageCapture() {
        // This line remains the same. photoInfo might be null or have a null uri.
        photoInfo = providerFileManager.generatePhotoUri(System.currentTimeMillis())


        photoInfo?.uri?.let { nonNullableUri ->
            // Inside this block, 'nonNullableUri' is a guaranteed non-null Uri.
            takePictureLauncher.launch(nonNullableUri)
        }
    }
    ...
    private fun openVideoCapture() {
        ...
        videoInfo?.uri?.let { nonNullableUri ->
            // Inside this block, 'nonNullableUri' is a guaranteed non-null Uri.
            takeVideoLauncher.launch(nonNullableUri)
        }
    }
